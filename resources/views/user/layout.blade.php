...
<body class="bg-gray-100 text-gray-900 flex min-h-screen transition-colors duration-300">
  ...
  <aside x-data="{ open: true }" :class="open ? 'w-64' : 'w-20'" class="bg-white min-h-screen border-r shadow-md flex flex-col transition-all duration-300">
    ...
    <nav class="flex-1 flex flex-col p-2 gap-1">
      <a href="{{ route('user.dashboard') }}" class="flex items-center gap-3 p-2 rounded hover:bg-blue-100 transition-colors duration-300" title="Dashboard">
...
<a href="{{ route('user.lessons.index') }}" class="flex items-center gap-3 p-2 rounded hover:bg-blue-100 transition-colors duration-300">
  <i data-feather="book-open"></i>
  <span x-show="open" class="truncate">Lessons</span>
</a>

<a href="{{ route('user.quizzes.index') }}" class="flex items-center gap-3 p-2 rounded hover:bg-blue-100 transition-colors duration-300">
  <i data-feather="edit-3"></i>
  <span x-show="open" class="truncate">Quizzes</span>
</a>

<a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 p-2 rounded hover:bg-blue-100 transition-colors duration-300">
  <i data-feather="edit-3"></i>
