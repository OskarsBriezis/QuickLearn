...
@section('content')
<h1 class="text-3xl font-bold mb-6 text-blue-600">Your Quiz History</h1>

@if($categories->isEmpty())
    <p class="text-gray-600 text-lg">You haven't attempted any quizzes yet.</p>
@else
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach($categories as $category)
            @php
                // Count quizzes attempted in this category
            ...
            <div class="bg-white rounded-xl shadow-md p-6 flex flex-col justify-between hover:shadow-lg transition-shadow duration-300">
                <div>
                    ...
                    <p class="text-gray-500 mb-2">Quizzes attempted: {{ $attempts }}</p>
                </div>
